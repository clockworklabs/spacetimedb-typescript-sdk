...
export namespace ServerMessage {
  ...
  export function getAlgebraicType(): AlgebraicType {
    return AlgebraicType.createSumType([
      new SumTypeVariant("InitialSubscription", __InitialSubscription.getAlgebraicType()),
      new SumTypeVariant("TransactionUpdate", __TransactionUpdate.getAlgebraicType()),
      new SumTypeVariant("IdentityToken", __IdentityToken.getAlgebraicType()),
      new SumTypeVariant("OneOffQueryResponse", __OneOffQueryResponse.getAlgebraicType()),
    ]);
  }
...
export type ServerMessage = ServerMessage.InitialSubscription | ServerMessage.TransactionUpdate | ServerMessage.IdentityToken | ServerMessage.OneOffQueryResponse;
